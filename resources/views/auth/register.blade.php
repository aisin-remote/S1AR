                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('store.register') }}" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="npk" type="npk" class="form-control" name="npk" value="{{ old('npk') }}" tabindex="1" required autofocus />
                                    </div>
                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input id="name" type="name" class="form-control" name="name" {{ old('name') }} tabindex="1" required autofocus />
                                    </div>
                                    <div class="form-group">
                                        <div class="d-block">
